...
def get_DOI(link):
	...
	ref_DOI = DOI[16:]  							#cut out url part
	return ref_DOI
...
def print_article_info(links): 						#input array of links
	...
	with open('data.csv', 'a') as csv_file:
		...
		writer.writerow(headers)  					#headers at top of excel file
		for row in data:
			writer.writerow(row)  					#add data to excel file